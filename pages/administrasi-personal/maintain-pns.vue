      ...
      <main class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="px-4 md:px-6 py-4 border-b bg-white flex-shrink-0">
          <div class="flex items-center justify-between">
            <h1 class="text-xl md:text-2xl font-bold text-gray-900">Maintain PNS</h1>
          ...
          <div class="p-4 md:p-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200/60 p-6">
              <div class="text-center py-12">
                <Icon name="lucide:user-check" class="w-16 h-16 mx-auto mb-4 text-gray-300" />
                <h3 class="text-lg font-semibold text-gray-900 mb-2">Maintain PNS</h3>
                <p class="text-gray-600">Halaman maintain PNS sedang dalam pengembangan</p>
              </div>
            </div>
          </div>
        </div>
