...
useHead({
  title: 'Data Area - Pengelolaan Organisasi'
})

// Nanti bisa fetch data dari API disini
// const { data: areaData } = await useFetch('/api/area')
      ...
      <main class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="px-4 md:px-6 py-4 border-b bg-white flex-shrink-0">
          <div class="flex items-center justify-between">
            <h1 class="text-xl md:text-2xl font-bold text-gray-900">Data Area</h1>
