      ...
      <div class="px-4 sm:px-6 pb-4">
        <table class="w-full min-w-[640px]">
          <thead class="bg-blue-100/60 rounded-t-xl">
            <tr>
              <th class="px-3 sm:px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wide first:rounded-tl-xl align-middle">
                <div class="ml-2 sm:ml-4">EMPLOYEE</div>
              </th>
              <th class="px-3 sm:px-6 py-4 text-center text-xs font-bold text-gray-600 uppercase tracking-wide">
                PERSNUM
              </th>
              <th class="px-3 sm:px-6 py-4 text-center text-xs font-bold text-gray-600 uppercase tracking-wide">
                GENDER
              ...
              <th class="px-3 sm:px-6 py-4 text-center text-xs font-bold text-gray-600 uppercase tracking-wide last:rounded-tr-xl">
                ACTION
              </th>
            </tr>
          </thead>
          <tbody class="bg-white">
            ...
            >
              <td class="px-3 sm:px-6 py-4 whitespace-nowrap align-middle">
                <div class="flex items-center gap-2 sm:gap-3 ml-2 sm:ml-4">
                  <!-- Avatar dengan initials -->
                  <div 
                    :class="[
                      'w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-white text-xs sm:text-sm font-semibold flex-shrink-0',
                  ...
                  <!-- Name and Position -->
                  <div class="min-w-0">
                    <p class="text-sm font-semibold text-gray-900 truncate">{{ item.employee }}</p>
                    <p class="text-xs text-gray-500 truncate">{{ item.position || 'Senior Manager' }}</p>
                  </div>
                </div>
              </td>
              <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-center text-sm text-gray-700 font-medium">
                {{ item.persnum }}
              </td>
              <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-center text-sm text-gray-600">
                {{ item.gender }}
              </td>
              <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-center text-sm text-gray-600">
                <span class="hidden sm:inline">{{ item.office }}</span>
                <span class="sm:hidden">{{ item.office.split(' ')[0] }}</span>
              </td>
