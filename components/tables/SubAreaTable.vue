...
// components/tables/SubAreaTable.vue
...
const dummyData: SubArea[] = [
  ...
  },
  {
    idSubArea: '1004',
    titelatur: '-',
    description: 'CABANG PEMBANTU CURUG',
    start: '20 Januari 2024',
    validTo: '30 April 2024'
  },
  {
  ...
  },
  {
    idSubArea: '1006',
    titelatur: '-',
    description: 'CABANG PEMBANTU CIREBON',
    start: '20 Januari 2024',
    validTo: '30 April 2024'
  },
  {
...
const subAreaData = computed(() => 
  props.data && props.data.length > 0 ? props.data : dummyData
)

// Filter data based on search
const filteredData = computed(() => {
  if (!searchQuery.value) return subAreaData.value
  
  const query = searchQuery.value.toLowerCase()
  return subAreaData.value.filter(item => 
    item.idSubArea.toLowerCase().includes(query) ||
...
const saveCreate = () => {
  console.log('Creating sub area:', createData.value)
  closeCreateModal()
}
...
const saveEdit = () => {
  console.log('Editing sub area:', editData.value)
  closeEditModal()
}
...
<template>
  ...
  <div v-if="showCreateModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4">
      ...
      <div class="flex items-center justify-between px-6 py-4 bg-blue-500 rounded-t-lg">
        <h3 class="text-lg font-semibold text-white">Tambah Sub Area</h3>
      ...
      <div class="p-6 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
        <!-- ID Sub Area -->
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">ID Sub Area</label>
          <input 
            v-model="createData.idSubArea"
            type="text" 
            placeholder="ID Sub Area"
  ...
  <div v-if="showEditModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4">
      <!-- Modal Header -->
      <div class="flex items-center justify-between px-6 py-4 bg-blue-500 rounded-t-lg">
        <h3 class="text-lg font-semibold text-white">Edit Sub Area</h3>
