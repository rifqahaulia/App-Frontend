...
<template>
  <aside class="w-20 bg-white border-r border-gray-200 flex flex-col items-center py-4 h-full overflow-y-auto">
    <div class="flex flex-col gap-3 w-full items-center">
      <NuxtLink
        ...
        :to="item.path"
        :class="[
          'w-11 h-11 rounded-full flex items-center justify-center transition-all duration-300 group relative flex-shrink-0',
          isActive(item.path) 
